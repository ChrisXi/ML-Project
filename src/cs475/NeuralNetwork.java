...
public class NeuralNetwork extends Predictor{
	...
	public NeuralNetwork() {
		...
		for(int n=0; n<this.neuronNum.length-1; n++) {
			int preNeuronNum = this.neuronNum[n]+1; //neuron Number (In previous neuron Layer) plus one bias
			int postNeuronNum = this.neuronNum[n+1]; //neuron Number In next neuron Layer
